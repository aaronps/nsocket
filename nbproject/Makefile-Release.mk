...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/nsocket

dist/Release/GNU-Linux-x86/nsocket: ${OBJECTFILES}
...
${OBJECTDIR}/src/NSocket/NSocket.o: src/NSocket/NSocket.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/NSocket/NSocket.o src/NSocket/NSocket.cpp

${OBJECTDIR}/src/minidnsq.o: src/minidnsq.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/minidnsq.o src/minidnsq.cpp

${OBJECTDIR}/src/NSocket/NSocketManager.o: src/NSocket/NSocketManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/NSocket
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/NSocket/NSocketManager.o src/NSocket/NSocketManager.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/nsocket
